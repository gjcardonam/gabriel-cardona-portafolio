...
export function SectionTitle({ number, eyebrow, title, description }: Props) {
  return (
    <header className="mb-12 max-w-3xl">
      ...
      <h2 className="font-display mt-6 text-balance text-[clamp(2.5rem,6vw,4.5rem)] uppercase text-ink">
        {title}
      </h2>
      {description && (
        <p className="mt-5 max-w-2xl text-pretty text-base leading-relaxed text-ink-soft">
          {description}
        </p>
      )}
    </header>
